...
class bot_tech():
  ...
  async def forge_research(self):
    ...
    if (
        self.bot.structures(UnitTypeId.CYBERNETICSCORE).ready and self.bot.can_afford(AbilityId.RESEARCH_WARPGATE)
    ...
    if (
        self.bot.structures(UnitTypeId.TWILIGHTCOUNCIL).ready and self.bot.can_afford(AbilityId.RESEARCH_BLINK)
