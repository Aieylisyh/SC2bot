    ...
    def init_zone_pathing(self):
        ...
        try:
            if 2 not in self.gather_points:
                ...
                assert path_to_third.distance > 0.0
                last_path_index = len(path_to_third.path) - 1
                assert last_path_index >= 0
        ...
        # catch AssertionError
            ...
            # hack for unpathable third base, such as is found on the sc2-ai-cup-2022 map
            self.print("Pathing check to third base failed. Continuing...", stats=False, log_level=logging.WARNING)
